...
<footer class="py-1 bg-dark">
	<div class="container">
		<p class="m-0 text-center text-white"><fmt:message key="footer.copyright" /></p>
	</div>
	<!-- /.container -->
</footer>

<!-- Bootstrap core JavaScript -->
<script src="${resourcesPath}/vendor/jquery/jquery.min.js"></script>
<script src="${resourcesPath}/vendor/popper/popper.min.js"></script>
...
<!-- Plugin Sorttable -->
<script src="${resourcesPath}/js/sorttable.js"></script>
